...
export const PRICING_FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: `Premium ($${pricing.premium.priceMonthly}/month, or $${pricing.premium.priceAnnual}/year) unlocks unlimited personalized discovery and Surprise Me, more specific categories in Discover (e.g. "Italian Restaurant" instead of "Food & Drink"), the AI Weekend Planner and Trip Planner, advanced filters, premium and exclusive experiences, and Travel Mode for 10+ destinations.`,
  },
  {
