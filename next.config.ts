    ...
    return [
      {
        ...
        headers: [
          ...
          // geolocation=(self) -- not the default-blocking geolocation=() this
          // used to be -- since the map's GeolocateControl and the "use my
          // location" features both need navigator.geolocation to work at
          // all. (self) still blocks any third-party iframe from requesting
          // it; camera/microphone stay fully disabled since nothing here uses
          // them.
